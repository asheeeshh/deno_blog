...
export async function handler(
  ...
  if (post) {
    return html({
      ...
      styles: [
        gfm.CSS,
        `.markdown-body { --color-canvas-default: transparent; --color-canvas-subtle: #2a2c2d; --color-fg-muted: rgba(203, 213, 219,0.2); --color-fg-default: #cbd5db; } .markdown-body img + p { margin-top: 16px; }`,
        ...(blogState.style ? [blogState.style] : []),
